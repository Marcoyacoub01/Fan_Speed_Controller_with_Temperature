...
void LCD_init(void)
{
	 ...
	 * you should send these two commands in order like this
	 * not clear enough in the data sheet why these commands
	 * but we think it is because the default for the lcd is 8 bit mode so if you want
	 * to use 4 -bits mode you should use these two commands and sent them in order as follow
	 */
...
void LCD_moveCursor(uint8 row,uint8 col)
{
	 ...
	 * now you have the address to move the cursor to specified address
